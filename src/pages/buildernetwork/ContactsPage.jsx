import { Card, Grid, IconButton, Paper, Table, TableBody, TableCell, TableContainer, TableHead, TableRow } from "@mui/material";
...
export default function ContactsPage() {
    ...
    return (
        <>
            ...
            <TableContainer component={Paper} className="contact-list">
